...
const FMP_INSIDER_MAX_PAGES = 42;

/** Newest-first Form 4 search; forty-two FMP pages take AAPL through February 2007. */
...
const FMP_INSIDER_HUB_PAGES = 41;
const FMP_TRANSCRIPT_HUB_PAGES = 47;
const FMP_GRADES_NEWS_PAGES = 45;
const FMP_INSTITUTIONAL_HUB_PAGES = 45;
