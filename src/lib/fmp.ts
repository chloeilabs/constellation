...
const FMP_INSIDER_MAX_PAGES = 56;

/** Newest-first Form 4 search; fifty-six FMP pages take AAPL through January 2005. */
...
const FMP_INSIDER_HUB_PAGES = 55;
const FMP_TRANSCRIPT_HUB_PAGES = 61;
const FMP_GRADES_NEWS_PAGES = 59;
const FMP_INSTITUTIONAL_HUB_PAGES = 59;
