...
const FMP_INSIDER_MAX_PAGES = 44;

/** Newest-first Form 4 search; forty-four FMP pages take AAPL through April 2006. */
...
const FMP_INSIDER_HUB_PAGES = 43;
const FMP_TRANSCRIPT_HUB_PAGES = 49;
const FMP_GRADES_NEWS_PAGES = 47;
const FMP_INSTITUTIONAL_HUB_PAGES = 47;
