...
const FMP_INSIDER_MAX_PAGES = 46;

/** Newest-first Form 4 search; forty-six FMP pages take AAPL through March 2006. */
...
const FMP_INSIDER_HUB_PAGES = 45;
const FMP_TRANSCRIPT_HUB_PAGES = 51;
const FMP_GRADES_NEWS_PAGES = 49;
const FMP_INSTITUTIONAL_HUB_PAGES = 49;
