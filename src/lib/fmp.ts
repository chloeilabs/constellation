...
const FMP_INSIDER_MAX_PAGES = 54;

/** Newest-first Form 4 search; fifty-four FMP pages take AAPL through October 19, 2005. */
...
const FMP_INSIDER_HUB_PAGES = 53;
const FMP_TRANSCRIPT_HUB_PAGES = 59;
const FMP_GRADES_NEWS_PAGES = 57;
const FMP_INSTITUTIONAL_HUB_PAGES = 57;
