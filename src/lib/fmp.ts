...
const FMP_INSIDER_MAX_PAGES = 58;

/** Newest-first Form 4 search; fifty-eight FMP pages take AAPL through January 11, 2005. */
...
const FMP_INSIDER_HUB_PAGES = 57;
const FMP_TRANSCRIPT_HUB_PAGES = 63;
const FMP_GRADES_NEWS_PAGES = 61;
const FMP_INSTITUTIONAL_HUB_PAGES = 61;
