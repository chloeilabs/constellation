...
const FMP_INSIDER_MAX_PAGES = 40;

/** Newest-first Form 4 search; forty FMP pages take AAPL through August 2007. */
...
const FMP_INSIDER_HUB_PAGES = 39;
const FMP_TRANSCRIPT_HUB_PAGES = 45;
const FMP_GRADES_NEWS_PAGES = 43;
const FMP_INSTITUTIONAL_HUB_PAGES = 43;
