...
const FMP_INSIDER_MAX_PAGES = 52;

/** Newest-first Form 4 search; fifty-two FMP pages are still on the October 2005 dump. */
...
const FMP_INSIDER_HUB_PAGES = 51;
const FMP_TRANSCRIPT_HUB_PAGES = 57;
const FMP_GRADES_NEWS_PAGES = 55;
const FMP_INSTITUTIONAL_HUB_PAGES = 55;
