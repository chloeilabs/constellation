...
const FMP_INSIDER_MAX_PAGES = 24;

/** Newest-first Form 4 search; twenty-four FMP pages take AAPL through early 2013. */
...
const FMP_INSIDER_HUB_PAGES = 23;
const FMP_TRANSCRIPT_HUB_PAGES = 29;
const FMP_GRADES_NEWS_PAGES = 27;
const FMP_INSTITUTIONAL_HUB_PAGES = 27;
