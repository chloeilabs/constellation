...
const FMP_INSIDER_MAX_PAGES = 62;

/** Newest-first Form 4 search; sixty-two FMP pages take AAPL through April 2004. */
...
const FMP_INSIDER_HUB_PAGES = 61;
const FMP_TRANSCRIPT_HUB_PAGES = 61;
const FMP_GRADES_NEWS_PAGES = 65;
const FMP_INSTITUTIONAL_HUB_PAGES = 65;
