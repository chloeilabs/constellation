...
const FMP_INSIDER_MAX_PAGES = 30;

/** Newest-first Form 4 search; thirty FMP pages take AAPL through mid-2011. */
...
const FMP_INSIDER_HUB_PAGES = 29;
const FMP_TRANSCRIPT_HUB_PAGES = 35;
const FMP_GRADES_NEWS_PAGES = 33;
const FMP_INSTITUTIONAL_HUB_PAGES = 33;
const FMP_SEC_8K_HUB_PAGES = 11;
