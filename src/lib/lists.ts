...
export const STOCK_LISTS = {
  ...
  "denmark-stocks": {
    title: "Nasdaq Copenhagen",
    description:
      "The largest companies listed on Nasdaq Copenhagen, ranked by market cap. A and B share classes are listed separately.",
    category: "international",
    source: "screener",
  ...
  "belgium-stocks": {
    ...
    description: "The largest companies listed on Euronext Brussels, ranked by market cap.",
    category: "international",
    source: "screener",
  ...
  "finland-stocks": {
    ...
    description: "The largest companies listed on Nasdaq Helsinki, ranked by market cap.",
    category: "international",
    source: "screener",
  ...
  "greece-stocks": {
    ...
    description: "The largest companies listed on the Athens Stock Exchange, ranked by market cap.",
    category: "international",
    source: "screener",
...
export const LIST_SLUG_ALIASES: Record<string, StockListSlug> = {
  ...
  bmv: "mexico-stocks",
  "copenhagen-stock-exchange": "denmark-stocks",
  "nasdaq-copenhagen": "denmark-stocks",
  ...
  gpw: "warsaw-stocks",
  "euronext-brussels": "belgium-stocks",
  "nasdaq-helsinki": "finland-stocks",
  ...
  "chi-x": "cboe-europe",
  "athens-stock-exchange": "greece-stocks",
