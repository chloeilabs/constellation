...
export const STOCK_LISTS = {
  ...
  "poland-stocks": {
    ...
    description: "The largest companies listed on the Warsaw Stock Exchange, ranked by market cap.",
    category: "international",
    source: "screener",
  ...
  "austria-stocks": {
    title: "Wiener Börse",
    description: "The largest companies listed on the Vienna Stock Exchange, ranked by market cap.",
    category: "international",
    source: "screener",
...
export const LIST_SLUG_ALIASES: Record<string, StockListSlug> = {
  ...
  "warsaw-stock-exchange": "poland-stocks",
  gpw: "poland-stocks",
  ...
  "vienna-stock-exchange": "austria-stocks",
  "wiener-borse": "austria-stocks",
