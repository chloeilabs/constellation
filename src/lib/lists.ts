...
export const STOCK_LISTS = {
  ...
  "tsx-stocks": {
    title: "Canada (TSX)",
    description: "The largest Canadian companies listed on the TSX, ranked by market cap.",
  ...
  "toronto-stocks": {
    ...
    description:
      "The largest listings FMP quotes on the TSX, ranked by market cap. Dual listings of foreign issuers are included.",
    category: "international",
    source: "screener",
    filters: { exchange: "TSX" },
    limit: 100,
    sort: "marketCap",
    listing: "raw",
    symbolPattern: "^[A-Z0-9]+\\.TO$",
  ...
  "london-stocks": {
    title: "United Kingdom (LSE)",
    description: "The largest U.K. companies listed on the London Stock Exchange, ranked by market cap.",
    category: "international",
    source: "screener",
  ...
  "lse-stocks": {
    ...
    description:
      "The largest listings FMP quotes on the London Stock Exchange, ranked by market cap. Dual listings of foreign issuers are included.",
    category: "international",
    source: "screener",
    filters: { exchange: "LSE" },
    limit: 100,
    sort: "marketCap",
    listing: "raw",
    symbolPattern: "^[A-Z0-9]+\\.L$",
  ...
  "australia-stocks": {
    title: "Australia (ASX)",
    description: "The largest Australian companies listed on the ASX, ranked by market cap.",
    category: "international",
    source: "screener",
  ...
  "asx-stocks": {
    ...
    description:
      "The largest listings FMP quotes on the ASX, ranked by market cap. Dual listings of foreign issuers are included.",
    category: "international",
    source: "screener",
    filters: { exchange: "ASX" },
    limit: 100,
    sort: "marketCap",
    listing: "raw",
    symbolPattern: "^[A-Z0-9]{2,4}\\.AX$",
  ...
  "dusseldorf-stocks": {
    title: "Dusseldorf Stock Exchange",
    description:
      "The largest listings FMP quotes on the Dusseldorf Stock Exchange, ranked by market cap. Dual listings of foreign issuers are included.",
    category: "international",
    source: "screener",
    filters: { exchange: "DUS" },
    limit: 100,
    sort: "marketCap",
    listing: "raw",
    symbolPattern: "^[A-Z0-9]+\\.DU$",
  },
  "hamburg-stocks": {
    title: "Hamburg Stock Exchange",
    description:
      "The largest listings FMP quotes on the Hamburg Stock Exchange, ranked by market cap. Dual listings of foreign issuers are included.",
    category: "international",
    source: "screener",
    filters: { exchange: "HAM" },
    limit: 100,
    sort: "marketCap",
    listing: "raw",
    symbolPattern: "^[A-Z0-9]+\\.HM$",
  },
  "munich-stocks": {
    title: "Munich Stock Exchange",
    description:
      "The largest listings FMP quotes on the Munich Stock Exchange, ranked by market cap. Dual listings of foreign issuers are included.",
    category: "international",
    source: "screener",
    filters: { exchange: "MUN" },
    limit: 100,
    sort: "marketCap",
    listing: "raw",
    symbolPattern: "^[A-Z0-9]+\\.MU$",
  },
  "stuttgart-stocks": {
    title: "Stuttgart Stock Exchange",
    description:
      "The largest listings FMP quotes on the Stuttgart Stock Exchange, ranked by market cap. Dual listings of foreign issuers are included.",
    category: "international",
    source: "screener",
    filters: { exchange: "STU" },
    limit: 100,
    sort: "marketCap",
    listing: "raw",
    symbolPattern: "^[A-Z0-9]+\\.SG$",
  },
  "cboe-europe": {
    title: "Cboe Europe",
    description:
      "The largest listings FMP quotes on Cboe Europe (DXE), ranked by market cap. Dual listings of foreign issuers are included.",
    category: "international",
    source: "screener",
    filters: { exchange: "DXE" },
    limit: 100,
    sort: "marketCap",
    listing: "raw",
    symbolPattern: "^[A-Z0-9]+\\.XD$",
  },
  "japan-stocks": {
  ...
  "france-stocks": {
    title: "France (Euronext Paris)",
    description: "The largest French companies listed on Euronext Paris, ranked by market cap.",
    category: "international",
    source: "screener",
  ...
  "paris-stocks": {
    ...
    description:
      "The largest listings FMP quotes on Euronext Paris, ranked by market cap. Dual listings of foreign issuers are included.",
    category: "international",
    source: "screener",
    filters: { exchange: "PAR" },
    limit: 100,
    sort: "marketCap",
    listing: "raw",
    symbolPattern: "^[A-Z0-9]+\\.PA$",
  ...
  "shanghai-stocks": {
    ...
    description: "The largest companies listed in Shanghai, ranked by market cap.",
    category: "international",
    source: "screener",
    filters: { exchange: "SHH", country: "CN" },
    limit: 100,
    sort: "marketCap",
    listing: "raw",
    symbolPattern: "^[0-9]+\\.SS$",
  },
  "korea-stocks": {
    title: "Korea Exchange (KOSPI)",
    description: "The largest companies listed on KOSPI, ranked by market cap.",
    category: "international",
    source: "screener",
    filters: { exchange: "KSC", country: "KR" },
    limit: 100,
    sort: "marketCap",
    listing: "raw",
  ...
  "canadian-securities-exchange": {
    ...
    description: "The largest listings on the Canadian Securities Exchange (CSE), ranked by market cap.",
    category: "international",
    source: "screener",
    filters: { exchange: "CNQ" },
    limit: 100,
    sort: "marketCap",
    listing: "raw",
    symbolPattern: "^[A-Z0-9-]+\\.CN$",
  },
  "cboe-canada": {
    title: "Cboe Canada",
    description: "The largest listings on Cboe Canada (NEO), ranked by FMP market cap.",
    category: "international",
    source: "screener",
    filters: { exchange: "NEO" },
    limit: 100,
    sort: "marketCap",
    listing: "raw",
    symbolPattern: "\\.NE$",
  ...
  "taipei-exchange": {
    ...
    description: "The largest companies listed on the Taipei Exchange (TPEx), ranked by market cap.",
    category: "international",
    source: "screener",
    filters: { exchange: "TWO", country: "TW" },
    limit: 100,
    sort: "marketCap",
    listing: "raw",
    symbolPattern: "^[0-9]+\\.TWO$",
  },
  "swiss-stocks": {
    title: "Switzerland (SIX)",
    description: "The largest Swiss companies listed on the SIX Swiss Exchange, ranked by market cap.",
    category: "international",
    source: "screener",
    filters: { exchange: "SIX", country: "CH" },
    limit: 100,
    sort: "marketCap",
    listing: "raw",
  ...
  "six-stocks": {
    ...
    description:
      "The largest listings FMP quotes on the SIX Swiss Exchange, ranked by market cap. Dual listings of foreign issuers are included.",
    category: "international",
    source: "screener",
    filters: { exchange: "SIX" },
    limit: 100,
    sort: "marketCap",
    listing: "raw",
    symbolPattern: "^[A-Z0-9]+\\.SW$",
  ...
  "taiwan-stocks": {
    ...
    description: "The largest companies listed on the Taiwan Stock Exchange, ranked by market cap.",
    category: "international",
    source: "screener",
    filters: { exchange: "TAI", country: "TW" },
    limit: 100,
    sort: "marketCap",
    listing: "raw",
  ...
  "singapore-stocks": {
    title: "Singapore (SGX)",
    description: "The largest Singaporean companies listed on the Singapore Exchange, ranked by market cap.",
    category: "international",
    source: "screener",
    filters: { exchange: "SES", country: "SG" },
    limit: 100,
    sort: "marketCap",
    listing: "raw",
  ...
  "sgx-stocks": {
    ...
    description:
      "The largest listings FMP quotes on the Singapore Exchange, ranked by market cap. Dual listings of foreign issuers are included.",
    category: "international",
    source: "screener",
    filters: { exchange: "SES" },
    limit: 100,
    sort: "marketCap",
    listing: "raw",
    symbolPattern: "^[A-Z0-9]+\\.SI$",
  ...
  "amsterdam-stocks": {
    ...
    description: "The largest Dutch companies listed on Euronext Amsterdam, ranked by market cap.",
    category: "international",
    source: "screener",
    filters: { exchange: "AMS", country: "NL" },
    limit: 100,
    sort: "marketCap",
    listing: "raw",
  ...
  "ams-stocks": {
    ...
    description:
      "The largest listings FMP quotes on Euronext Amsterdam, ranked by market cap. Dual listings of foreign issuers are included.",
    category: "international",
    source: "screener",
    filters: { exchange: "AMS" },
    limit: 100,
    sort: "marketCap",
    listing: "raw",
    symbolPattern: "^[A-Z0-9]+\\.AS$",
  ...
  "italy-stocks": {
    ...
    description: "The largest companies listed on Borsa Italiana in Milan, ranked by market cap.",
    category: "international",
    source: "screener",
    filters: { exchange: "MIL", country: "IT" },
    limit: 100,
    sort: "marketCap",
    listing: "raw",
  ...
  "spain-stocks": {
    title: "Spain (Madrid)",
    description: "The largest Spanish companies listed on the Bolsa de Madrid, ranked by market cap.",
    category: "international",
    source: "screener",
    filters: { exchange: "BME", country: "ES" },
    limit: 100,
    sort: "marketCap",
    listing: "raw",
  ...
  "madrid-stocks": {
    title: "Madrid Stock Exchange",
    description:
      "The largest listings FMP quotes on the Bolsa de Madrid, ranked by market cap. Dual listings of foreign issuers are included.",
    category: "international",
    source: "screener",
    filters: { exchange: "BME" },
    limit: 100,
    sort: "marketCap",
    listing: "raw",
    symbolPattern: "^[A-Z0-9]+\\.MC$",
  ...
  "sweden-stocks": {
    title: "Sweden (Nasdaq Stockholm)",
    description:
      "The largest Swedish companies listed on Nasdaq Stockholm, ranked by market cap. A and B share classes are listed separately.",
    category: "international",
    source: "screener",
    filters: { exchange: "STO", country: "SE" },
    limit: 100,
    sort: "marketCap",
    listing: "raw",
  ...
  "stockholm-stocks": {
    ...
    description:
      "The largest listings FMP quotes on Nasdaq Stockholm, ranked by market cap. Dual listings of foreign issuers are included.",
    category: "international",
    source: "screener",
    filters: { exchange: "STO" },
    limit: 100,
    sort: "marketCap",
    listing: "raw",
    symbolPattern: "^[A-Z0-9-]+\\.ST$",
  ...
  "mexico-stocks": {
    title: "Mexico (BMV)",
    description: "The largest Mexican companies listed on the Mexican Stock Exchange, ranked by market cap.",
    category: "international",
    source: "screener",
    filters: { exchange: "MEX", country: "MX" },
    limit: 100,
    sort: "marketCap",
    listing: "raw",
  ...
  "mex-stocks": {
    ...
    description:
      "The largest listings FMP quotes on the Mexican Stock Exchange, ranked by market cap. Dual listings of foreign issuers are included.",
    category: "international",
    source: "screener",
    filters: { exchange: "MEX" },
    limit: 100,
    sort: "marketCap",
    listing: "raw",
    symbolPattern: "^[A-Z0-9&-]+\\.MX$",
  ...
  "denmark-stocks": {
    title: "Denmark (Nasdaq Copenhagen)",
    description:
      "The largest Danish companies listed on Nasdaq Copenhagen, ranked by market cap. A and B share classes are listed separately.",
    category: "international",
    source: "screener",
    filters: { exchange: "CPH", country: "DK" },
    limit: 100,
    sort: "marketCap",
    listing: "raw",
  ...
  "copenhagen-stocks": {
    title: "Copenhagen Stock Exchange",
    description:
      "The largest listings FMP quotes on Nasdaq Copenhagen, ranked by market cap. Dual listings of foreign issuers are included.",
    category: "international",
    source: "screener",
    filters: { exchange: "CPH" },
    limit: 100,
    sort: "marketCap",
    listing: "raw",
    symbolPattern: "^[A-Z0-9-]+\\.CO$",
  ...
  "norway-stocks": {
    title: "Oslo Børs",
    description: "The largest companies listed on Oslo Børs, ranked by market cap.",
    category: "international",
    source: "screener",
    filters: { exchange: "OSL", country: "NO" },
    limit: 100,
    sort: "marketCap",
    listing: "raw",
  ...
  "israel-stocks": {
    ...
    description: "The largest companies listed on the Tel Aviv Stock Exchange, ranked by market cap.",
    category: "international",
    source: "screener",
    filters: { exchange: "TLV", country: "IL" },
    limit: 100,
    sort: "marketCap",
    listing: "raw",
  ...
  "south-africa-stocks": {
    title: "South Africa (JSE)",
    description: "The largest South African companies listed on the JSE, ranked by market cap.",
    category: "international",
    source: "screener",
    filters: { exchange: "JNB", country: "ZA" },
    limit: 100,
    sort: "marketCap",
    listing: "raw",
  ...
  "jse-stocks": {
    ...
    description:
      "The largest listings FMP quotes on the JSE, ranked by market cap. Dual listings of foreign issuers are included.",
    category: "international",
    source: "screener",
    filters: { exchange: "JNB" },
    limit: 100,
    sort: "marketCap",
    listing: "raw",
    symbolPattern: "^[A-Z0-9]+\\.JO$",
  ...
  "new-zealand-stocks": {
    title: "New Zealand (NZX)",
    description: "The largest New Zealand companies listed on the NZX, ranked by market cap.",
    category: "international",
    source: "screener",
    filters: { exchange: "NZE", country: "NZ" },
    limit: 100,
    sort: "marketCap",
    listing: "raw",
  ...
  "nzx-stocks": {
    ...
    description:
      "The largest listings FMP quotes on the NZX, ranked by market cap. Dual listings of foreign issuers are included.",
    category: "international",
    source: "screener",
    filters: { exchange: "NZE" },
    limit: 100,
    sort: "marketCap",
    listing: "raw",
    symbolPattern: "^[A-Z0-9]+\\.NZ$",
  ...
  "poland-stocks": {
    title: "Poland (GPW)",
    description: "The largest Polish companies listed on the Warsaw Stock Exchange, ranked by market cap.",
    category: "international",
    source: "screener",
    filters: { exchange: "WSE", country: "PL" },
    limit: 100,
    sort: "marketCap",
    listing: "raw",
  ...
  "warsaw-stocks": {
    ...
    description:
      "The largest listings FMP quotes on the Warsaw Stock Exchange, ranked by market cap. Dual listings of foreign issuers are included.",
    category: "international",
    source: "screener",
    filters: { exchange: "WSE" },
    limit: 100,
    sort: "marketCap",
    listing: "raw",
    symbolPattern: "^[A-Z0-9]+\\.WA$",
  ...
  "belgium-stocks": {
    title: "Belgium (Euronext Brussels)",
    description: "The largest Belgian companies listed on Euronext Brussels, ranked by market cap.",
    category: "international",
    source: "screener",
    filters: { exchange: "BRU", country: "BE" },
    limit: 100,
    sort: "marketCap",
    listing: "raw",
  ...
  "brussels-stocks": {
    ...
    description:
      "The largest listings FMP quotes on Euronext Brussels, ranked by market cap. Dual listings of foreign issuers are included.",
    category: "international",
    source: "screener",
    filters: { exchange: "BRU" },
    limit: 100,
    sort: "marketCap",
    listing: "raw",
    symbolPattern: "^[A-Z0-9]+\\.BR$",
  ...
  "finland-stocks": {
    title: "Finland (Nasdaq Helsinki)",
    description: "The largest Finnish companies listed on Nasdaq Helsinki, ranked by market cap.",
    category: "international",
    source: "screener",
    filters: { exchange: "HEL", country: "FI" },
    limit: 100,
    sort: "marketCap",
    listing: "raw",
  ...
  "helsinki-stocks": {
    title: "Nasdaq Helsinki",
    description:
      "The largest listings FMP quotes on Nasdaq Helsinki, ranked by market cap. Dual listings of foreign issuers are included.",
    category: "international",
    source: "screener",
    filters: { exchange: "HEL" },
    limit: 100,
    sort: "marketCap",
    listing: "raw",
    symbolPattern: "^[A-Z0-9-]+\\.HE$",
  ...
  "indonesia-stocks": {
    ...
    description: "The largest companies listed on the Indonesia Stock Exchange, ranked by market cap.",
    category: "international",
    source: "screener",
    filters: { exchange: "JKT", country: "ID" },
    limit: 100,
    sort: "marketCap",
    listing: "raw",
  ...
  "malaysia-stocks": {
    ...
    description: "The largest companies listed on Bursa Malaysia, ranked by market cap.",
    category: "international",
    source: "screener",
    filters: { exchange: "KLS", country: "MY" },
    limit: 100,
    sort: "marketCap",
    listing: "raw",
  ...
  "austria-stocks": {
    title: "Wiener Börse",
    description: "The largest Austrian companies listed on the Vienna Stock Exchange, ranked by market cap.",
    category: "international",
    source: "screener",
    filters: { exchange: "VIE", country: "AT" },
    limit: 100,
    sort: "marketCap",
    listing: "raw",
  ...
  "vienna-stocks": {
    ...
    description:
      "The largest listings FMP quotes on the Vienna Stock Exchange, ranked by market cap. Dual listings of foreign issuers are included.",
    category: "international",
    source: "screener",
    filters: { exchange: "VIE" },
    limit: 100,
    sort: "marketCap",
    listing: "raw",
    symbolPattern: "^[A-Z0-9]+\\.VI$",
  ...
  "greece-stocks": {
    title: "Greece (Athens)",
    description: "The largest Greek companies listed on the Athens Stock Exchange, ranked by market cap.",
    category: "international",
    source: "screener",
    filters: { exchange: "ATH", country: "GR" },
    limit: 100,
    sort: "marketCap",
    listing: "raw",
  ...
  "athens-stocks": {
    title: "Athens Stock Exchange",
    description:
      "The largest listings FMP quotes on the Athens Stock Exchange, ranked by market cap. Dual listings of foreign issuers are included.",
    category: "international",
    source: "screener",
    filters: { exchange: "ATH" },
    limit: 100,
    sort: "marketCap",
    listing: "raw",
    symbolPattern: "^[A-Z0-9]+\\.AT$",
  ...
  "turkey-stocks": {
    ...
    description: "The largest companies listed on Borsa Istanbul, ranked by market cap.",
    category: "international",
    source: "screener",
    filters: { exchange: "IST", country: "TR" },
    limit: 100,
    sort: "marketCap",
    listing: "raw",
  ...
  "thailand-stocks": {
    ...
    description:
      "The largest common shares listed on the SET, ranked by market cap. Non-voting depository receipts (-R) are excluded.",
    category: "international",
    source: "screener",
    filters: { exchange: "SET", country: "TH" },
    limit: 100,
    sort: "marketCap",
    listing: "raw",
  ...
  "saudi-stocks": {
    title: "Saudi Exchange (Tadawul)",
    description: "The largest companies listed on the Saudi Exchange, ranked by market cap.",
    category: "international",
    source: "screener",
    filters: { exchange: "SAU", country: "SA" },
    limit: 100,
    sort: "marketCap",
    listing: "raw",
  ...
  "qatar-stocks": {
    ...
    description: "The largest companies listed on the Qatar Stock Exchange, ranked by market cap.",
    category: "international",
    source: "screener",
    filters: { exchange: "DOH", country: "QA" },
    limit: 100,
    sort: "marketCap",
    listing: "raw",
  ...
  "chile-stocks": {
    ...
    description: "The largest companies listed on the Santiago Stock Exchange, ranked by market cap.",
    category: "international",
    source: "screener",
    filters: { exchange: "SGO", country: "CL" },
    limit: 100,
    sort: "marketCap",
    listing: "raw",
  ...
  "portugal-stocks": {
    title: "Portugal (Euronext Lisbon)",
    description: "The largest Portuguese companies listed on Euronext Lisbon, ranked by market cap.",
    category: "international",
    source: "screener",
    filters: { exchange: "LIS", country: "PT" },
    limit: 100,
    sort: "marketCap",
    listing: "raw",
  ...
  "lisbon-stocks": {
    ...
    description:
      "The largest listings FMP quotes on Euronext Lisbon, ranked by market cap. Dual listings of foreign issuers are included.",
    category: "international",
    source: "screener",
    filters: { exchange: "LIS" },
    limit: 100,
    sort: "marketCap",
    listing: "raw",
    symbolPattern: "^[A-Z0-9]+\\.LS$",
  ...
  "argentina-stocks": {
    title: "Argentina (BYMA)",
    description: "The largest Argentine companies listed on BYMA, ranked by market cap.",
    category: "international",
    source: "screener",
  ...
  "bcba-stocks": {
    ...
    description:
      "The largest listings FMP quotes on BYMA, ranked by market cap. Dual listings of foreign issuers are included.",
    category: "international",
    source: "screener",
    filters: { exchange: "BUE" },
    limit: 100,
    sort: "marketCap",
    listing: "raw",
    symbolPattern: "^[A-Z0-9]+\\.BA$",
...
export const LIST_SLUG_ALIASES: Record<string, StockListSlug> = {
  ...
  "dusseldorf-stock-exchange": "dusseldorf-stocks",
  dusseldorf: "dusseldorf-stocks",
  duesseldorf: "dusseldorf-stocks",
  "hamburg-stock-exchange": "hamburg-stocks",
  hamburg: "hamburg-stocks",
  "munich-stock-exchange": "munich-stocks",
  munich: "munich-stocks",
  "stuttgart-stock-exchange": "stuttgart-stocks",
  stuttgart: "stuttgart-stocks",
  ...
  lse: "lse-stocks",
  "toronto-stock-exchange": "toronto-stocks",
  ...
  kospi: "korea-stocks",
  "south-korea-stocks": "korea-stocks",
  cse: "canadian-securities-exchange",
  "cse-stocks": "canadian-securities-exchange",
  neo: "cboe-canada",
  "neo-exchange": "cboe-canada",
  tpex: "taipei-exchange",
  "taipei-stocks": "taipei-exchange",
  "six-swiss-exchange": "six-stocks",
  six: "six-stocks",
  "switzerland-stocks": "swiss-stocks",
  "taiwan-stock-exchange": "taiwan-stocks",
  twse: "taiwan-stocks",
  "singapore-exchange": "sgx-stocks",
  sgx: "sgx-stocks",
  "euronext-amsterdam": "ams-stocks",
  ams: "ams-stocks",
  "netherlands-stocks": "amsterdam-stocks",
  "borsa-italiana": "italy-stocks",
  "milan-stocks": "italy-stocks",
  "madrid-stock-exchange": "madrid-stocks",
  "bolsa-madrid": "madrid-stocks",
  madrid: "madrid-stocks",
  "nasdaq-stockholm": "stockholm-stocks",
  stockholm: "stockholm-stocks",
  "mexican-stock-exchange": "mex-stocks",
  bmv: "mex-stocks",
  mex: "mex-stocks",
  "copenhagen-stock-exchange": "copenhagen-stocks",
  "nasdaq-copenhagen": "copenhagen-stocks",
  copenhagen: "copenhagen-stocks",
  "oslo-bors": "norway-stocks",
  oslo: "norway-stocks",
  "tel-aviv-stock-exchange": "israel-stocks",
  tase: "israel-stocks",
  "johannesburg-stock-exchange": "jse-stocks",
  jse: "jse-stocks",
  "new-zealand-stock-exchange": "nzx-stocks",
  nzx: "nzx-stocks",
  "warsaw-stock-exchange": "warsaw-stocks",
  gpw: "warsaw-stocks",
  "euronext-brussels": "brussels-stocks",
  brussels: "brussels-stocks",
  "nasdaq-helsinki": "helsinki-stocks",
  helsinki: "helsinki-stocks",
  "indonesia-stock-exchange": "indonesia-stocks",
  idx: "indonesia-stocks",
  "bursa-malaysia": "malaysia-stocks",
  klse: "malaysia-stocks",
  "vienna-stock-exchange": "vienna-stocks",
  "wiener-borse": "vienna-stocks",
  vienna: "vienna-stocks",
  dxe: "cboe-europe",
  "bats-chi-x": "cboe-europe",
  "chi-x": "cboe-europe",
  "athens-stock-exchange": "athens-stocks",
  athens: "athens-stocks",
  "borsa-istanbul": "turkey-stocks",
  bist: "turkey-stocks",
  "stock-exchange-of-thailand": "thailand-stocks",
  set: "thailand-stocks",
  "saudi-stock-exchange": "saudi-stocks",
  tadawul: "saudi-stocks",
  "qatar-stock-exchange": "qatar-stocks",
  "santiago-stock-exchange": "chile-stocks",
  "euronext-lisbon": "lisbon-stocks",
  lisbon: "lisbon-stocks",
