...
export const STOCK_LISTS = {
  ...
  "spain-stocks": {
    ...
    description: "The largest companies listed on the Bolsa de Madrid, ranked by market cap.",
    category: "international",
    source: "screener",
  ...
  "portugal-stocks": {
    ...
    description: "The largest companies listed on Euronext Lisbon, ranked by market cap.",
    category: "international",
    source: "screener",
...
export const LIST_SLUG_ALIASES: Record<string, StockListSlug> = {
  ...
  "madrid-stock-exchange": "spain-stocks",
  "bolsa-madrid": "spain-stocks",
