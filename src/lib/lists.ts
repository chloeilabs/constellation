...
export const STOCK_LISTS = {
  ...
  "swiss-stocks": {
    ...
    description: "The largest companies listed on the SIX Swiss Exchange, ranked by market cap.",
    category: "international",
    source: "screener",
  ...
  "amsterdam-stocks": {
    ...
    description: "The largest companies listed on Euronext Amsterdam, ranked by market cap.",
    category: "international",
    source: "screener",
  ...
  "sweden-stocks": {
    ...
    description:
      "The largest companies listed on Nasdaq Stockholm, ranked by market cap. A and B share classes are listed separately.",
    category: "international",
    source: "screener",
...
export const LIST_SLUG_ALIASES: Record<string, StockListSlug> = {
  ...
  "six-swiss-exchange": "swiss-stocks",
  six: "swiss-stocks",
  ...
  "euronext-amsterdam": "amsterdam-stocks",
  ...
  "nasdaq-stockholm": "sweden-stocks",
  "stockholm-stocks": "sweden-stocks",
