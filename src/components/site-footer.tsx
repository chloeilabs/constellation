...
const columns = [
  ...
  },
  {
    ...
    links: [
      ...
      ["/list/online-gambling", "Online Gambling"],
      ...
      ["/list/frankfurt-stocks", "Frankfurt"],
      ["/list/japan-stocks", "Tokyo (JPX)"],
      ["/list/korea-stocks", "Korea (KOSPI)"],
      ["/list/shanghai-stocks", "Shanghai"],
      ["/list/shenzhen-stocks", "Shenzhen"],
      ...
      ["/list/artificial-intelligence-etfs", "AI ETFs"],
      ["/list/australian-etfs", "Australian ETFs"],
      ["/list/canadian-etfs", "Canadian ETFs"],
