    ...
    <Container>
      ...
      <form className="mb-8 grid gap-3 rounded-lg border border-border bg-muted-bg p-4 sm:grid-cols-5">
        ...
        <label className="text-sm">
          ...
          <input name="shares" type="number" min={1} defaultValue={shares} className="h-9 w-full rounded-md border border-border bg-white px-2" />
        </label>
        <label className="text-sm">
          <span className="mb-1 block text-muted">Years</span>
          <input name="years" type="number" min={1} max={40} defaultValue={years} className="h-9 w-full rounded-md border border-border bg-white px-2" />
        </label>
