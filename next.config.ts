...
const nextConfig: NextConfig = {
  ...
  async redirects() {
    return [
      ...
      { source: "/list/singapore-exchange", destination: "/list/singapore-stocks", permanent: false },
      ...
      { source: "/list/mexican-stock-exchange", destination: "/list/mexico-stocks", permanent: false },
      ...
      { source: "/list/johannesburg-stock-exchange", destination: "/list/south-africa-stocks", permanent: false },
      { source: "/list/new-zealand-stock-exchange", destination: "/list/new-zealand-stocks", permanent: false },
