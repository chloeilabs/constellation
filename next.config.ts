...
const nextConfig: NextConfig = {
  ...
  async redirects() {
    return [
      ...
      { source: "/list/six-swiss-exchange", destination: "/list/swiss-stocks", permanent: false },
      ...
      { source: "/list/euronext-amsterdam", destination: "/list/amsterdam-stocks", permanent: false },
      ...
      { source: "/list/nasdaq-stockholm", destination: "/list/sweden-stocks", permanent: false },
