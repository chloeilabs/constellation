...
const nextConfig: NextConfig = {
  ...
  async redirects() {
    return [
      ...
      { source: "/list/copenhagen-stock-exchange", destination: "/list/denmark-stocks", permanent: false },
      { source: "/list/nasdaq-copenhagen", destination: "/list/denmark-stocks", permanent: false },
      ...
      { source: "/list/euronext-brussels", destination: "/list/belgium-stocks", permanent: false },
